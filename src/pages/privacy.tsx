          ...
          >
            <div className="p-8 rounded-xl border border-primary/20 bg-primary/5 mb-10">
              <p className="text-sm leading-relaxed text-muted-foreground">
                <strong className="text-foreground">Confidentiality Notice:</strong> OADIGI is committed to protecting the privacy and confidentiality of all individuals who interact with our platforms and services. This policy describes how we collect, use, and protect your personal information in accordance with responsible data handling principles.
              </p>
            </div>
            ...
            {[
              {
                title: "1. Who We Are",
                content: `OADIGI is a commercial holding company operating through two specialized divisions: OADIGI Tech (technology services) and OADIGI Strategy (business consulting). This privacy policy applies to all websites, services, and communications operated under the OADIGI brand.
