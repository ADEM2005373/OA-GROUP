      ...
      <section className="pt-40 pb-16 px-6">
        <div className="max-w-4xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-6">{t("legal.privacy.title")}</h1>
            <p className="text-muted-foreground text-lg">{t("legal.privacy.updated")}</p>
          </motion.div>
        </div>
      </section>
