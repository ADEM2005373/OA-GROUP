        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
              Our methodology is built on transparency, rigor, and genuine collaboration. Here's how every engagement at OADIGI unfolds — from first conversation to long-term partnership.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                OADIGI is structured to support long-term relationships. We want to be the firm you call when something important needs to be figured out — not just when a task needs to be executed.
              </p>
