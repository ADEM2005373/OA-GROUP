          ...
          >
            <div className="p-8 rounded-xl border border-primary/20 bg-primary/5 mb-10">
              <p className="text-sm leading-relaxed text-muted-foreground">
                <strong className="text-foreground">Important Notice:</strong> By accessing or using OADIGI's website and services, you agree to be bound by these Terms and Conditions. Please read them carefully. If you do not agree to these terms, please do not use our services.
              </p>
            </div>
            ...
            {[
              {
                ...
                content: `These Terms and Conditions govern your use of the OADIGI website and any services we provide. By accessing our website, submitting a contact form, or engaging our services, you accept these terms in full.

OADIGI reserves the right to update these terms at any time. Continued use of our services following any changes constitutes acceptance of the revised terms.`
              },
              {
                title: "2. Description of Services",
                content: `OADIGI provides technology and consulting services through two divisions:

OADIGI Tech: Software development, web and mobile applications, SaaS platforms, APIs, cloud deployment, AI integration, cybersecurity, and technical maintenance services.

OADIGI Strategy: Business consulting, startup analysis, digital transformation planning, market analysis, performance optimization, organizational strategy, and executive advisory services.

Specific terms for individual service engagements are defined in separate service agreements.`
              },
              {
                title: "3. Intellectual Property",
                content: `All content on this website — including text, graphics, logos, and design elements — is the property of OADIGI and is protected by applicable intellectual property laws.

Work product developed for clients is governed by the terms of the relevant service agreement. Unless otherwise specified in writing, OADIGI retains ownership of all tools, frameworks, methodologies, and reusable components developed during client engagements. Clients receive a license to use the deliverables as specified in their agreements.`
              },
              {
                title: "4. Client Confidentiality",
                content: `OADIGI takes client confidentiality seriously. Information shared with us during consultations, proposals, or service engagements is treated as confidential and will not be disclosed to third parties without your consent, except as required by law.

We expect clients to similarly protect confidential information shared by OADIGI during the course of a business relationship, including pricing, methodologies, and internal processes.`
              },
              {
                title: "5. Limitation of Liability",
                content: `To the maximum extent permitted by applicable law, OADIGI shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from the use of our website or services.
...
Our total liability for any claim arising from our services shall not exceed the amount paid by the client for the specific service giving rise to the claim.`
              },
              {
                ...
                content: `OADIGI represents that:
...
- Misrepresent your identity or affiliation when contacting us`
              },
              {
                ...
                content: `Our website may contain links to third-party websites. These links are provided for convenience and informational purposes only. OADIGI does not endorse, control, or assume responsibility for the content or practices of any third-party websites.`
              },
              {
